...
export default {
  data() {
    return {
        ...
        editMailInfo:false,
        typeZeroTags:['','','请及时支付...',['请及时上传快递单号...','请及时填写快递信息...','等待管理员收货并上传切片'],"您的病理切片正在等待专家会诊，请稍后等待...",'订单已退回.','诊断完成,如有疑问,请及时咨询会诊医生.','订单已取消.','请及时填写补充检查信息...','您的病理切片正在等待专家二次会诊，请稍后等待...','您的病理切片正在等待专家会诊，请稍后等待...'],
        typeOneTags:['','','','等待管理员收货并上传切片...',"病理切片正在等待专家会诊，请尽快处理...",'','已完成诊断,等待申请医生验收...','','等待申请医生填写补充检查信息...','补充检查信息已提交，请尽快处理...','该病理等待管理员同意退回...'],
        consultStatuss:['','待提交','待支付','待收货','待诊断','已退回','已诊断','已取消','待补充','待二次诊断','待诊断'],
    };
  },
